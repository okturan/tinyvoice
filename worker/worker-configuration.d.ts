/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: 508e855906cc4f99b5a99fd060b5bda1)
// Runtime types generated with workerd@1.20260714.1 2026-07-16 
interface __BaseEnv_Env {
	ROOMS: DurableObjectNamespace<import("./index").Room>;
	LOBBY: DurableObjectNamespace<import("./index").Lobby>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "Room" | "Lobby";
	}
